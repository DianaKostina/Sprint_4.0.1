...
class MainPage:
    ...
    RETURN_SCOOTER = (By.XPATH, "//div[@id='accordion__heading-28']")
    ASSERT_RETURN_SCOOTER = (By.XPATH, "//p[contains(text(),'Пока что нет! Но если что-то срочное — всегда можн')]")
    EXTENDING_OR_CANCELING_YOUR_ORDER = (By.XPATH, "//div[@id='accordion__heading-4']")
    ASSERT_EXTENDING_OR_CANCELING_YOUR_ORDER = (By.XPATH, "//p[contains(text(),'Пока что нет! Но если что-то срочное — всегда можн')]")
